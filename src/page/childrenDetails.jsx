...
import { 
    Card, CardContent, Typography, Avatar, CircularProgress, 
...
export const ChildrenDetails = () => {
    ...
    useEffect(() => {
        axios.get(`https://66722715e083e62ee43e2228.mockapi.io/Children/${id}`)
            .then((response) => {
    ...
    const handleSave = () => {
        axios.put(`https://66722715e083e62ee43e2228.mockapi.io/Children/${id}`, formData)
            .then((response) => {
                setChild(response.data);
                setIsEditing(false);
            })
                    ...
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={12} display="flex">
                                <Avatar src={child.picture} alt={child.fname} sx={{ width: 80, height: 80 }} />
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <TextField 
                                    ...
                                    name="birthdate" 
                                    type="date"
                                    value={new Date(formData.birthdate * 1000).toISOString().split('T')[0]} 
                                    onChange={handleChange} 
                                    disabled={!isEditing} 
                                    sx={{ 
                                        borderRadius: '200px', 
